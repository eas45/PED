...
// Operador asignación
TComplejo& TComplejo::operator= (const TComplejo &com) {
...
void TComplejo::Copia (const TComplejo &com) {
  re = com.Re();
  im = com.Im();
}
...
// Suma
TComplejo TComplejo::operator+ (const TComplejo &com) const {
...
TComplejo operator+ (const double d, const TComplejo &com) {
  TComplejo res = com + d;
...
// OTROS OPERADORES
bool TComplejo::operator== (const TComplejo &com) const{
...
void TComplejo::Re (const double &d) {
  re = d;
}

void TComplejo::Im (const double &d) {
  im = d;
}

// MÉTODOS Y FUNCIONES

void TComplejo::corregirCero () {
...
// Operador salida
ostream& operator<< (ostream &s, const TComplejo &com) {
  s << "(" << com.Re() << " " << com.Im() << ")";
